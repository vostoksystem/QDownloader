...
#include "../harbour-test_qdownload/src/test.h"
...
QT_MOC_LITERAL(4, 18, 6), // "target"
QT_MOC_LITERAL(5, 25, 5), // "error"
QT_MOC_LITERAL(6, 31, 27), // "QNetworkReply::NetworkError"
QT_MOC_LITERAL(7, 59, 6) // "status"

    },
    "Test\0success\0\0url\0target\0error\0"
    "QNetworkReply::NetworkError\0status"
};
...
static const uint qt_meta_data_Test[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, QMetaType::QUrl, 0x80000000 | 6,    3,    7,
...
void Test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->success((*reinterpret_cast< const QUrl(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->error((*reinterpret_cast< const QUrl(*)>(_a[1])),(*reinterpret_cast< QNetworkReply::NetworkError(*)>(_a[2]))); break;
        default: ;
        }
